...
//		new RefreshingTask().execute();
	...
	public void finishRefreshing(boolean isNetConnect) {
		currentStatus = STATUS_REFRESH_FINISHED;
		preferences.edit().putLong(UPDATED_AT + mId, System.currentTimeMillis()).commit();
		if(headerLayoutParams == null){
			return;
	...
	private void updateHeaderView() {
		if (lastStatus != currentStatus) {
			if (currentStatus == STATUS_PULL_TO_REFRESH) {
				...
				description.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM);
				...
				description.setText(getResources().getString(R.string.refreshing_finished));
				progressBar.setVisibility(View.GONE);
	...
	/**使用方法
	 * XML文件
	<com.kyc.coinsave.view.RefreshableView
